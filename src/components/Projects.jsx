        ...
        <section id="projects" className="py-20 px-6 md:px-16 relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                ...
                <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <p className="text-lg text-[var(--color-text)] mb-8 max-w-3xl mx-auto leading-relaxed">
                    ...
                    <div className="grid grid-cols-3 gap-6 max-w-md mx-auto mb-8">
                        ...
                        <div className="card rounded-xl border border-white/10">
                            ...
                            <div className="text-sm text-[var(--color-text)]/70">Projects</div>
                        </div>

                        <div className="card rounded-xl border border-white/10">
                            <div className="text-2xl font-bold text-[var(--color-primary)]">{stats.technologies}+</div>
                            <div className="text-sm text-[var(--color-text)]/70">Technologies</div>
                        </div>

                        <div className="card rounded-xl border border-white/10">
                            <div className="text-2xl font-bold text-[var(--color-primary)]">{stats.live}</div>
                            <div className="text-sm text-[var(--color-text)]/70">Live Demos</div>
                        </div>
                    ...
                    {filterCategories.map((category) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex cursor-pointer items-center gap-2 px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 ${
                                    isActive
                ...
                <div className={`text-center mt-16 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="max-w-2xl mx-auto p-8 bg-gradient-to-r from-[var(--color-primary)]/5 to-purple-600/5 backdrop-blur-sm border border-[var(--color-primary)]/10 rounded-2xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <a 
                                href="#contact" 
                                className="px-8 py-4 bg-gradient-to-r from-[var(--color-primary)] to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                            >
                                Get In Touch
                            </a>
                            <a 
                                ...
                                className="px-8 py-4 border-2 border-[var(--color-primary)] bg-[var(--color-primary)] text-[var(--button-text-color)] font-semibold rounded-xl hover:bg-[var(--color-primary)] transition-all duration-300 transform hover:scale-105"
                            >
                                View All on GitHub
                            </a>
                        </div>
